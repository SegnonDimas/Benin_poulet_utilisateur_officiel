...
class ResumeAuthentificationPage extends StatefulWidget {
  ...
  @override
  State<ResumeAuthentificationPage> createState() => _ResumeAuthentificationPageState();
}

class _ResumeAuthentificationPageState extends State<ResumeAuthentificationPage> {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  AppText(
                    text: "Veuillez d'abord remplir les informations d'authentification",
                    fontSize: mediumText(),
                    color: Colors.grey,
                  ),
                  SizedBox(height: 24),
                ...
                Expanded(
                  child: ListView(children: [
                    ...
                    ModelResumeTextField(
                      ...
                      valeur: sellerinfos.sellerCurrentLocation ?? 'Non renseigné',
                    ),
                    DottedLine(
                      dashColor:
                          Theme.of(context).colorScheme.inversePrimary.withOpacity(0.1),
                    ...
                    ModelResumeTextField(
                      ...
                      valeur: sellerinfos.idDocumentCountry ?? 'Non renseigné',
                    ),
                    DottedLine(
                      dashColor:
                          Theme.of(context).colorScheme.inversePrimary.withOpacity(0.1),
  ...
  void _navigateToModify() {
    ...
    Get.toNamed(AppRoutes.INFOPERSONNELLEPAGE);
  }
    ...
    try {
      ...
      if (currentState is! AuthentificationGlobalState) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Veuillez d\'abord remplir toutes les informations d\'authentification'),
            backgroundColor: Colors.orange,
          ),
        );
        return;
      ...
      if (currentUser != null) {
        ...
        final defaultPhotoUrl = 'https://media.istockphoto.com/id/612650934/fr/vectoriel/carte-didentit%C3%A9-isol%C3%A9e-sur-fond-blanc-ic%C3%B4ne-didentification-de-lentreprise.jpg?s=612x612&w=0&k=20&c=CWx0pfJc9ZaZmDYRbCWO3xi4iZg-YmUGUBM1aMcUSX0=';
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Informations d\'authentification soumises avec succès !'),
