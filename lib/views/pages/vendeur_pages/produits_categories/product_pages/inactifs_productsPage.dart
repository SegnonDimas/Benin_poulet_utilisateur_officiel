...
class _InactifsProductsPageState extends State<InactifsProductsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: list_produits_inactifs.isNotEmpty
          ? Column(
              children: [
                Expanded(
                  child: ListView.builder(
                      itemCount: list_produits_inactifs.length,
                      itemBuilder: (context, index) {
                        return Padding(
                            ...
                            child: SizedBox(
                                ...
                                child: ModelProduit(
                                    produit: list_produits_inactifs[index],
                                    onTap: () {
                                                                ...
                                                                showCupertinoDialog(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return PageView.builder(
                                                                          itemCount: list_produits_inactifs[index].productImagesPath!.length,
                                                                            ...
                                                                            return Scaffold(
                                                                              body: Stack(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Positioned(
                                                                                    top: 0,
                                                                                    child: Image.asset(height: context.height, width: context.width, fit: BoxFit.cover, list_produits_inactifs[index].productImagesPath![context.watch<ProductImagesPathIndexProvider>().indexProductImage]),
                                                                                  ),
                                                                              ...
                                                                              width: context.width,*/
                                                                                  ...
                                                                                  Positioned(
                                                                                    ...
                                                                                    child: ClipRRect(
                                                                                      ...
                                                                                      child: Image.asset(height: context.height * 0.5, width: context.width * 0.9, fit: BoxFit.cover, list_produits_inactifs[index].productImagesPath![context.watch<ProductImagesPathIndexProvider>().indexProductImage]),
                                                                                    ),
                                                                                  ),
                                                                                      ...
                                                                                      child: Row(
                                                                                        children: [
                                                                                          ...
                                                                                          Container(
                                                                                            ...
                                                                                            child: AppText(
                                                                                              text: list_produits_inactifs[index].productName!,
                                                              ...
                                                              child: ClipRRect(
                                                                ...
                                                                child:
                                                                  ...
                                                                  width: context
                                                                          .width *
                                                                      0.9,
                                                                  color: list_produits_inactifs[index].productImagesPath?[
                                                                              indexImagePath] ==
                                                                          null
                                                                      ? Theme.of(
                                                                              context)
                                                          ...
                                                          child:
                                                              ListView.builder(
                                                                  ...
                                                                  scrollDirection:
                                                                      Axis
                                                                          .horizontal,
                                                                  itemCount: list_produits_inactifs[
                                                                          index]
                                                                      .varieteProduitList!
                                                                      .length,
                                                                  itemBuilder:
                                                                      (context,
                                                                          indexVariete) {
                                                                    return ModelSecteur(
                                                                        text: list_produits_inactifs[index]
                                                                            .varieteProduitList![
                                                                                indexVariete]
                                                                            .toString(),
                                                                        isSelected:
                                                        ...
                                                        Expanded(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              AppText(
                                                                text:
                                                                    '${list_produits_inactifs[index].productUnitPrice} FCFA',
                                                                fontSize: context
                                                                    .mediumText,
                                                              ),
                                                            ],
                                                        ...
                                                        Flexible(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              AppText(
                                                                text:
                                                                    '${list_produits_inactifs[index].stockValue}',
                                                                fontSize: context
                                                                    .mediumText,
                                                              ),
                                                            ],
          ...
          : Center(
              child: Column(
                ...
                children: [
                  ...
                  AppText(
                    text: 'Aucun produit Inactif disponible',
