...
class TimelineTilePage_ extends StatefulWidget {
  const TimelineTilePage_({super.key});

  @override
  State<TimelineTilePage_> createState() => _TimelineTilePage_State();
}

class _TimelineTilePage_State extends State<TimelineTilePage_> {
  int pageIndex = 0;
            ...
            child: Row(
              ...
              children: List.generate(5, (index) {
                ...
                return ValueListenableBuilder<int>(
                  ...
                  builder: (context, value, child) {
                    Color tileColor =
                        (value >= index) ? Colors.green : Colors.grey.shade300;
